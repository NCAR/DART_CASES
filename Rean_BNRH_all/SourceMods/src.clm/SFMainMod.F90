  ...
  logical :: debug_mod = .false.  ! for debugging
...
contains
  ...
  !*****************************************************************.
    ...
    do while(associated(currentPatch))
       ...
       do while(associated(currentCohort))
          if (debug_mod) write(fates_log(),*) 'SF currentCohort%c_area ',currentCohort%c_area
  ...
  subroutine rate_of_spread ( currentSite ) 
    ...
    do while(associated(currentPatch))
       ...
       if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) &
       ...
       if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - beta ',beta
       if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - beta_op ',beta_op
       ...
       if (debug_mod) then
          if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - c ',c
          if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - currentPatch%effect_wspeed ', &
                                                                         currentPatch%effect_wspeed
          if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - b ',b
          if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - beta_ratio ',beta_ratio
          if ( hlm_masterproc == itrue .and.debug_mod) write(fates_log(),*) 'SF - e ',e
       endif
