    ...
    associate( rio_npatch_si           => this%rvars(ir_npatch_si)%int1d, &
       ...
       do s = 1,nsites
          ...
          do while(associated(cpatch))
             ...
             if ( debug_mod ) write(fates_log(),*) 'CLTV io_idx_pa_sunz 1 ',io_idx_pa_sunz
             
             if ( debug_mod ) write(fates_log(),*) 'CLTV 1186 ',nlevleaf,numpft,nclmax
             ...
             if ( debug_mod ) write(fates_log(),*) 'CLTV io_idx_pa_sunz 2 ',io_idx_pa_sunz
       ...
       do s = 1,nsites
          ...
          do idx_pa = 1,rio_npatch_si(io_idx_si)
             ...
             if (idx_pa == 1) then ! nothing associated yet. first patch is pointed to by youngest and oldest
                ...
                if ( debug_mod ) write(fates_log(),*) 'idx_pa = 1 ',idx_pa
                ...
                if ( debug_mod ) write(fates_log(),*) 'idx_pa = 2 ',idx_pa
     ...
     associate( rio_npatch_si         => this%rvars(ir_npatch_si)%int1d, &
       ...
       do s = 1,nsites
          ...
          do while(associated(cpatch))
             ...
             if ( debug_mod ) write(fates_log(),*) 'CVTL io_idx_pa_sunz 1 ',io_idx_pa_sunz
             ...
             if ( debug_mod ) write(fates_log(),*) 'CVTL io_idx_pa_sunz 2 ',io_idx_pa_sunz
